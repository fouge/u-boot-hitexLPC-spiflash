...
# ifndef  CONFIG_ENV1_ADDR
#  define CONFIG_ENV1_ADDR	(CONFIG_SYS_FLASH_BASE + CONFIG_ENV1_OFFSET)
# endif
# ifndef  CONFIG_ENV1_OFFSET
#  define CONFIG_ENV1_OFFSET (CONFIG_ENV1_ADDR - CONFIG_SYS_FLASH_BASE)
# endif
# if !defined(CONFIG_ENV1_ADDR_REDUND) && defined(CONFIG_ENV1_OFFSET_REDUND)
#  define CONFIG_ENV1_ADDR_REDUND	(CONFIG_SYS_FLASH_BASE + CONFIG_ENV1_OFFSET_REDUND)
# endif
...
# endif
# if defined(CONFIG_ENV1_ADDR_REDUND) && !defined(CONFIG_ENV_SIZE_REDUND)
#  define CONFIG_ENV_SIZE_REDUND	CONFIG_ENV_SIZE
# endif
# if (CONFIG_ENV1_ADDR >= CONFIG_SYS_MONITOR_BASE) && \
     (CONFIG_ENV1_ADDR+CONFIG_ENV_SIZE) <= (CONFIG_SYS_MONITOR_BASE + CONFIG_SYS_MONITOR_LEN)
...
# ifndef CONFIG_ENV1_OFFSET
#  error "Need to define CONFIG_ENV1_OFFSET when using CONFIG_ENV_IS_IN_NAND"
# endif
# ifndef CONFIG_ENV_SIZE
#  error "Need to define CONFIG_ENV_SIZE when using CONFIG_ENV_IS_IN_NAND"
# endif
# ifdef CONFIG_ENV1_OFFSET_REDUND
...
# ifndef CONFIG_ENV1_ADDR
#  error "Need to define CONFIG_ENV1_ADDR when using CONFIG_ENV_IS_IN_MG_DISK"
# endif
# ifndef CONFIG_ENV_SIZE
